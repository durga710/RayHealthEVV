 ...
 */
export function checkGeofence(clockLocation, client) {
    ...
    const distanceM = haversineMeters({ lat: clockLocation.lat, lng: clockLocation.lng }, { lat: client.latitude, lng: client.longitude });
