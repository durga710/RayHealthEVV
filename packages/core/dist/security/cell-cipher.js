...
function loadKey() {
    ...
    if (!raw) {
        throw new Error('ENCRYPTION_KEY env var is required for PHI column encryption. ' +
...
export function encryptCell(plain) {
    if (plain == null || plain === '')
        return null;
...
export function decryptCell(blob) {
    if (blob == null || blob === '')
        return blob ?? null;
...
//# sourceMappingURL=cell-cipher.js.map