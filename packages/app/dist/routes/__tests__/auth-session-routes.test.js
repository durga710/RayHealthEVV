...
describe('auth session routes', () => {
    it('sets an HttpOnly session cookie and returns csrf token on web login', async () => {
        ...
        vi.spyOn(core, 'SessionRepository').mockImplementation(() => ({ create: createSession }));
        vi.spyOn(core, 'AuditEventRepository').mockImplementation(() => ({ create: createAuditEvent }));
...
//# sourceMappingURL=auth-session-routes.test.js.map